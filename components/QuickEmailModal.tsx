...
const QuickEmailModal: React.FC<QuickEmailModalProps> = ({ isOpen, onClose, onSave, official }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[70] p-4">
      <div className="bg-gray-800 rounded-lg shadow-2xl w-full max-w-md">
        <div className="p-6 border-b border-gray-700 flex justify-between items-center">
          <div>
            <h2 className="text-xl font-bold text-white">Mettre à jour l'E-mail</h2>
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            <label htmlFor="quick-email" className="block text-sm font-medium text-gray-300 mb-1">Adresse e-mail</label>
